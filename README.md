...
| [Credential Gateway](recipes/credential-gateway.md) | — | Gmail + Calendar + Drive / Docs access |
...
| [GDrive-to-Brain](recipes/gdrive-to-brain.md) | credential-gateway | Google Docs in a chosen Drive root become brain pages |
